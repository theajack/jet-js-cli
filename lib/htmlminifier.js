  ...
  Object.keys(values).forEach(function(key) {
    ...
    if (key === 'caseSensitive') {
      ...
      options.minifyJS = function(text, inline) {
        ...
        if(options.useBabel){
          var babelRes=babel.transformSync(code, {
            presets: ['@babel/env']
          });
          code=babelRes.code;
        }
        ...
        // console.log('UglifyJS start',code,value);
        if(!options.compressJs){
          return code;
        }
        var result = UglifyJS.minify(code, value);
        // console.log('UglifyJS end',result);
        if (result.error) {
  ...
  new HTMLParser(value, {
    ...
    chars: function(text, prevTag, nextTag) {
      ...
      if (isExecutableScript(currentTag, currentAttrs)) {
        //console.log(currentTag,currentAttrs)
      ...
      if (isStyleSheet(currentTag, currentAttrs)) {
        ...
        //       text = options.minifyCSS(result.css);
        //       _this.lessCallback(text,prevTag,nextTag)
        //     }).catch(function(){
      ...
      //console.log(this.lessCallback)
      //this.lessCallback(text,prevTag,nextTag)
